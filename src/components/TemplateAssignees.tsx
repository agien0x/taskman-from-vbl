...
import { TemplateAssignment } from '@/hooks/useTemplateAssignments';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip';

interface TemplateAssigneesProps {
  assignments: TemplateAssignment[];
  maxVisible?: number;
}

export const TemplateAssignees = ({ assignments, maxVisible = 3 }: TemplateAssigneesProps) => {
